...
const Text_Image_Comp = ({ para = true, reverse=true }) => {
  return (
    <div
      className={`flex items-center justify-center lg:gap-8 flex-col ${
        reverse ? "lg:flex-row" : "md:flex-row-reverse"
      } ${para ? "":"md:flex-row"} gap-5 px-3 md:px-4 lg:px-10 py-10 `}
    >
      <div className={`lg:w-[40%] md:px-5 lg:px-0 ${para ? "":"md:w-[60%]"}`}>
