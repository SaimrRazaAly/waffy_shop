...
const Product_Card_Shop = ({ title, image, price, show_Btn = false }) => {
  return (
    <div className="relative group flex  text-center flex-col items-center justify-center cursor-pointer shadow-lg bg-white p-2 overflow-hidden transition-colors duration-300">
      {/* 4 animated borders */}
      ...
      <div className="p-[30px]">
        ...
        <p className="mb-[10px] text-[16px] font-medium">${price}</p>
      </div>
      {
        show_Btn &&(
